...
public class FileListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(), expressions.size(), Toast.LENGTH_SHORT).show();
        ...
        //Toast.makeText(getApplicationContext(), "No of files: " + String.valueOf(strs.length), Toast.LENGTH_SHORT).show();
